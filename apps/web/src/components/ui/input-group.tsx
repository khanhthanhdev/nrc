...
export function InputGroupButton({ className, variant = "ghost", size = "icon-xs", ...props }: ButtonProps): React.ReactElement {
  return (
    <Button
      variant={variant}
      size={size}
