...
+-----------------------------------------------------------------------------+
|                                                                             |
|  # 2026 Season Events (Vietnam)                       [ Season Switch v ]   |
|                                                                             |
|  +-----------------------------------------------------------------------+  |
...
| Events        |  - 2026: Into the Deep  [ Published ] [ Edit ]              |
| Registrations |  - 2025: Submerged       [ Archived ]  [ Edit ]              |
|               |  - 2024: Centerstage     [ Archived ]  [ Edit ]              |
| ADMINISTRATION|                                                             |
| ────────────  |  ## Active Season                                           |
| Users         |  Current: 2026  [ Change ]                                  |
| Sync Logs     |                                                             |
| Settings      |                                                             |
|               |                                                             |
| ────────────  |                                                             |
